<?php 
    ...
    incluirTemplate('header',$inicio = "inicio");//Para pasar a la funcion si esta pagina incluye "inicio"
?>
    ...
    <div class="contenedor seccion seccion-inferior">
        ...
        <section class="testimoniales">
            ...
            <div class="testimonial">
                <blockquote>
                    El personal se comporto de una excelente forma, muy buena atención y la casa que me
